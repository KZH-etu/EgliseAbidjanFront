...
export const mockAdminAboutSections = [
  ...
  },
  {
    ...
    translations: [
      {
        lang: 'fr',
        title: '1. Dieu veille sur Sa Parole',
        description: [
          "Le Nouveau Testament a commencé avec l’accomplissement fidèle des promesses divines. Ce que Dieu a annoncé par la bouche de Ses prophètes ne demeure jamais lettre morte. Ainsi, les prophéties d’Ésaïe (40:3) et de Malachie (3:1) concernant la voix criant dans le désert et préparant le chemin du Seigneur se sont accomplies dans le ministère de <strong>Jean-Baptiste</strong>, identifié par Jésus comme l’Élie promis pour Sa première venue (Matthieu 11:10 ; Marc 1:1-4).",
          "De la même manière, la promesse que <strong>Élie devait venir avant le 'grand et redoutable jour du Seigneur'</strong> (Malachie 4:5) reste encore valable pour notre temps. Notre Seigneur a confirmé cette prophétie dans le Nouveau Testament : <strong>« Élie doit venir premièrement et rétablir toutes choses. »</strong> (Matthieu 17:11)",
        ]
      },
      {
        lang: 'en',
  ...
  },
  {
    ...
    translations: [
      {
        lang: 'fr',
        title: '2. Le ministère prophétique pour notre génération',
        description: [
          "C’est dans cette ligne prophétique que s’inscrit le ministère de <strong>William Branham</strong>, que nous reconnaissons comme l’accomplissement de cette promesse biblique. Le 11 juin 1933, lors d’un baptême dans la rivière Ohio, une lumière surnaturelle descendit des cieux, et une voix divine déclara : <strong>« Comme Jean-Baptiste a été envoyé pour précéder la première venue de Christ, le message qui t’est confié précédera la seconde venue de Christ. »</strong>",
          "Plusieurs témoins ont confirmé cet événement, et au fil des années, d'autres signes surnaturels ont suivi. Le plus connu est cette photo prise en 1950 à Houston, où une <strong>lumière céleste apparut au-dessus de la tête de William Branham</strong>, validée plus tard par des experts du FBI. Ces manifestations confirment ce que Dieu a toujours fait dans les moments clés de l’histoire du salut : Il accompagne <strong>Ses appels divins par des signes visibles.</strong>",
        ]
      },
      {
        lang: 'en',
  ...
  },
  {
    ...
    translations: [
      {
        lang: 'fr',
        title: '3. Le retour à la Parole originelle',
        description: [
          "Le but de cette visitation divine n’est pas d’élever un homme, mais de ramener l’Église à <strong>la Parole pure et aux fondements apostoliques</strong>. Dieu appelle Son peuple à sortir de toute confusion religieuse pour revenir aux enseignements des apôtres et des prophètes, Jésus-Christ étant <strong>la pierre angulaire</strong> (Éphésiens 2:20).",
          "Dans un monde religieux rempli de programmes, de dénominations et d’interprétations humaines, Dieu parle encore aujourd’hui. <strong>Il envoie Sa Parole au temps convenable</strong>, et distribue la nourriture spirituelle pour préparer l’Épouse de Christ à Sa venue (Matthieu 24:45).",
          "<i>« L’homme ne vivra pas de pain seulement, mais de toute Parole qui sort de la bouche de Dieu. »</i> (Matthieu 4:4)",
        ]
      },
      {
        lang: 'en',
  ...
  },
  {
    ...
    translations: [
      {
        lang: 'fr',
        title: '4. Le temps du rétablissement est maintenant',
        description: [
          "L’apôtre Pierre, après la Pentecôte, déclara que Jésus-Christ doit rester au ciel jusqu’au <strong>temps du rétablissement de toutes choses</strong> (Actes 3:21). Nous croyons que <strong>ce temps est maintenant arrivé</strong>. C’est le moment de reconnaître ce que Dieu fait dans Son Église et de s’y soumettre avec foi et humilité.",
          "Dieu n’a jamais laissé son peuple dans l’ignorance. Dans chaque génération, Il a envoyé des hommes mandatés, porteurs d’un message divin. Le ministère de William Branham, avec son appel surnaturel et son enseignement conforme aux Écritures, s’inscrit dans cette continuité divine. Il <strong>n’ajoute rien à la Parole</strong>, mais ramène à ce qui a été dit dès le commencement.",
        ]
      },
      {
        lang: 'en',
  ...
  },
  {
    ...
    translations: [
      {
        lang: 'fr',
        title: '5. Une Église préparée pour l’enlèvement',
        description: [
          "Nous sommes au temps de <strong>l’achèvement du plan du Salut</strong>. Dieu construit Son Église, non selon les structures humaines, mais selon Son modèle éternel. Il appelle les siens à sortir de toute captivité religieuse pour <strong>former un seul Corps, uni dans la vérité</strong>.",
          "Ce message de restauration vise à préparer une Église sans tache ni ride, fidèle à la Parole et prête pour <strong>l’enlèvement glorieux</strong>. Comme il est écrit :",
          "<i>« Seuls ceux qui sont de Dieu entendent les paroles de Dieu. »</i> (Jean 8:47)",
          "À travers l’histoire, les chefs religieux ont souvent manqué ce que Dieu faisait. Ils ont rejeté Jean-Baptiste, se sont opposés à Jésus-Christ, et aujourd’hui encore, beaucoup passent à côté de l’accomplissement prophétique en cours.",
        ]
      },
      {
        lang: 'en',
  ...
  },
  {
    ...
    translations: [
      {
        lang: 'fr',
        title: '6. Un appel personnel et solennel',
        description: [
          "Aujourd’hui, <strong>Dieu parle à Son peuple,</strong> non par une nouvelle religion, mais par <strong>le retour à la foi des pères</strong>. Il invite Son peuple à la repentance, à la foi véritable et à la séparation du monde religieux pour vivre selon <strong>la volonté parfaite de Dieu.</strong>",
          "<i>« Toutes les promesses de Dieu sont Oui et Amen en Jésus-Christ. »</i> (2 Corinthiens 1:20)",
          "Le temps est court. Le message est clair. <strong>Le Seigneur revient,</strong> et ceux qui ont l’oreille spirituelle entendront l’appel.",
        ]
      },
      {
        lang: 'en',
    ...
    links: [
      ...
      { text: 'Qui est Ewald Frank?', url: '../about/frank' }
    ]
  },
];
